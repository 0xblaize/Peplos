...
export default function DashboardPage() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      if (saved) {
        ...
        setBasePhotoUrl('/base-model-placeholder.svg');
      }
    }
  }, []);
  ...
  function scrollToCloset() {
    const el = document.getElementById('closet');
    if (!el) return;
